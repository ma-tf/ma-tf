    ...
    <Section>
      ...
      <SectionContent>
        <p className="max-w-xl indent-8 text-xl text-foreground">
          My music splits into two strands. The drum and bass leans into an atmospheric style. Long
          evolving pads sit under chopped breaks, the space left between them doing as much work as
          the drums themselves. It is built around tension and groove - breaks cut up and
          re-assembled, with percussion threading through the gaps to keep things moving forward.
          The ambient work moves slower, toward darker, more sinister soundscapes. Drone and texture
          over melody, made to fill a room rather than hold a hook.
        </p>
