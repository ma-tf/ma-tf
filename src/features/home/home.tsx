  ...
  return (
    <div className="flex h-dvh justify-center bg-background text-foreground">
      <div className="flex flex-col justify-center">
        ...
        <p className="mb-8 animate-fade-up text-lg text-muted-foreground animation-delay-100">
          Something is on its way.
        </p>
        <div className="flex animate-fade-up flex-col gap-3 animation-delay-200">
